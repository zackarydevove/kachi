 ...
 * In production: prepends AVATAR_S3_BUCKET_URL to the key (e.g., /avatars/uuid.jpg)
 * In development: returns the value as-is (base64 data URL)
 */
export function getAvatarUrl(
  ...
  // In development, return as-is (base64 data URL)
  return avatar;
}
